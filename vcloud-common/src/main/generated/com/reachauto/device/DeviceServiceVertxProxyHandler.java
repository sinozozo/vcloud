...
public class DeviceServiceVertxProxyHandler extends ProxyHandler {
  ...
  public void handle(Message<JsonObject> msg) {
    try {
      ...
      switch (action) {
        case "addDevice": {
          service.addDevice(json.getJsonObject("device") == null ? null : new com.reachauto.device.Device(json.getJsonObject("device")), createHandler(msg));
          break;
        }
        case "deleteDevice": {
        ...
        case "updateDevice": {
          service.updateDevice(json.getJsonObject("device") == null ? null : new com.reachauto.device.Device(json.getJsonObject("device")), res -> {
            if (res.failed()) {
