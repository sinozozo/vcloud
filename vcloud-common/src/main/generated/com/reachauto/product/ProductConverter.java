...
/**
 * Converter for {@link com.reachauto.product.Product}.
 *
 * NOTE: This class has been automatically generated from the {@link com.reachauto.product.Product} original class using Vert.x codegen.
 */
public class ProductConverter {
  ...
  public static void toJson(Product obj, JsonObject json) {
    if (obj.getAccount() != null) {
      json.put("account", obj.getAccount().toJson());
    }
